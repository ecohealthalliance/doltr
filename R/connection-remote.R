...
#'
#' This method wraps functions from [dbx::dbxInsert()] because that implementation
#' is much more performant than the standard method from `[RMariaDB::dbWriteTable()]`,
#' due to the way Dolt handles repeat `INSERT` insert statements.
#'
#' This may be removed if the base issue is resolved: <https://github.com/dolthub/dolt/issues/2091>.
#'
